...
$hora00=$una[$n].":00:00";
$hora11=$una[$n].":59:50";
$PAGOS = oci_parse($conn,"SELECT COUNT((TLT_DATE_END-TLT_DATE_BEGIN)*24*60*60) FROM TP_LOG_TRANSACTION  WHERE TCT_ID=803 AND TLT_DATE_BEGIN BETWEEN TO_DATE('$fecha $hora00','DD/MM/YYYY HH24:MI:SS')AND TO_DATE('$fecha $hora11','DD/MM/YYYY HH24:MI:SS') AND USR_ID='25635' AND(TLT_DATE_END-TLT_DATE_BEGIN)*24*60*60>=10 ORDER by  TLT_DATE_BEGIN");
oci_execute($PAGOS);
if ($cont==1) 
  {
