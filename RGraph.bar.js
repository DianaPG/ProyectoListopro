    ...
    RGraph.Bar = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.background.grid.color':  '#c3d33a',
            ...
            'chart.strokecolor':            '#c3d33a',
            'chart.axis.color':             '#c3d33a',
            ...
            'chart.yaxispos':               'left',
            'chart.text.angle':             0,
            'chart.text.color':             '#c3d33a', // Gradients aren't supported for this color
            'chart.text.size':              10,
            'chart.text.font':              'Arial',
            'chart.ymin':                   0,
            'chart.ymax':                   null,
            'chart.title':                  '',
            'chart.title.color':            '#c3d33a',
            ...
            'chart.shadow':                 true,
            'chart.shadow.color':           '',  // Gradients aren't supported for this color
            ...
            'chart.highlight.stroke':       '#c3d33a',
            'chart.highlight.fill':         '#c3d33a',
            'chart.key':                    null,
            'chart.key.background':         '#c3d33a',
            'chart.key.position':           'graph',
            'chart.key.shadow':             false,
            'chart.key.shadow.color':       '#c3d33a',
            ...
            'chart.key.interactive.highlight.chart.stroke':'#c3d33a',
            'chart.key.interactive.highlight.chart.fill':'#c3d33a',
            'chart.key.interactive.highlight.label':'#c3d33a',
            ...
            'chart.crosshairs.color':       '##c3d33a',
            'chart.crosshairs.hline':       true,
            'chart.crosshairs.vline':       true,
            'chart.linewidth':              1,
            'chart.annotatable':            false,
            'chart.annotate.color':         '#c3d33a',
